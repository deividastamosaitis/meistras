...
const Quixote = (props) => (
  <Document>
    <Page size="A4" style={styles.body}>
      <Text style={styles.title}>Sutartis nr.: {props.data}</Text>
      <Text style={styles.datatext}>{props.data}</Text>
      <Text style={styles.datatext2}>Kaunas</Text>
      <Text style={styles.text}>
        Uždaroji akcinė bendrovė “TODESA“ (įmonės kodas 302041568, įregistruota
        2008m. Spalio 16 d., kuri įsikūrusi veiklos adresu Kaune, Jonavos g.
        204a), toliau vadinama “VYKDYTOJU“, veikianti pagal bendrovės įstatus,
        atstovaujama direktoriaus Ričardo Pūko, ir{" "}
      ...
      <Text style={styles.punktai}>
        ...
        atliktas sumontavus vaizdo stebėjimo įrangą ir atlikus jos konfigūravimo
        darbus užsakovo adresu. Sekantis ar vėlesnis konfigūravimas pagal
        kliento vėlesnius pageidavimus, apmokamas 1 asmens taikomu valandiniu
        įkainiu, kuris nurodytas 3.2 punkte
      </Text>
      ...
      <Text style={styles.punktai}>
        ...
        nustatyti kitokie darbų pradžios darbai arba keičiami dėl netinkamų oro
        sąlygų, gamtos stichijų ir kitų atvejų, kurie kelia pavojų darbuotojams
        ar yra netinkamos gamtos sąlygos įrangos montavimui. Esant ligų,
      ...
      <Text style={styles.punktai}>
        ...
        kodekso 6.669 straipsnio nustatytų konfidencialumo reikalavimų, taip pat
        laikyti puslapyje užsakovo objekte įrengtų prietaisų sudėtį ir schemas.
      </Text>
      <Text style={styles.punktai}>
      ...
      <Text style={styles.punktai}>
        ...
        išsinuomoti reikiamą techniką saugiam darbų atlikimui, o esančius nuomos
        kaštus apmokės Užsakovas, baigus darbus, išskyrus, jei yra sutarta
        kitaip. Jei Užsakovas savo turima technika ar įranga padeda atlikti
        darbus, Užsakovas yra atsakingas už darbų saugą.
      </Text>
      <Text style={styles.title}>3. Atsiskaitymo suma, įkainiai ir tvarka</Text>
      <Text style={styles.punktai}>
        3.1 Vykdytojo darbų atlikimo įkainis yra valandinis, kuris skaičiuojamas
        nuo išvykimo iš Vykdytojo veiklos adreso, darbų atlikimo laikas pas
        užsakovą iki grįžimo į vykdytojo veiklos adresą, kuris yra Kaune,
        Jonavos g. 204a.
      </Text>
      <Text style={styles.punktas}>
        3.2 <Text style={styles.insert}>Montavimo darbų įkainis </Text>
        kiekvienam objekte dirbančiam vykdytojo darbuotojui yra 60€ + PVM/1val.
        Patikslinimas, jei sutarta kitaip:{" "}
        <Text style={styles.insert}>{props.patikslinimas} </Text> + PVM.
      </Text>
      <Text style={styles.punktas}>
      ...
      <Text style={styles.punktas}>
        ...
        taikomas +50% , o darbų atlikimas šventinėmis ir ne darbo dienomis +100%
        koeficientas išskyrus atvejus, jei su užsakovu sutaryta kitaip
        (tekstinis pagrindas).
      </Text>
      <Text style={styles.punktai}>
        3.3 Užsakovas už atliktus darbus atsiskaito per 2 darbo dienas, nuo tos
        datos, kai vykdytojas atsiunčia PVM sąskaitą-faktūrą, už atliktus
        ...
        įrangą, jos priedus, komponentus ir kitus priedus, kurių reikėjo darbams
        atlikti. Išskyrus atvejus, jei raštiškai sutarta kitaip (tekstinis
        pagrindas).
      </Text>
      <Text style={styles.punktai}>
        3.4 Visa atsiskaitymo suma turi būti išmokėta vykdytojui per 2 darbo
        dienas, to neatlikus, užsakovas traktuoja kaip įsipareigojimų nevykdymu
        ir be oficialaus įspėjimo skaičiuoja 0,5% dydžio delspinigius kiekvienai
        kalendorinei dienai visai sąskaitos sumai išskyrus atvejus, jei sutarta
        kitaip (tekstiniu pagrindu)
      </Text>
      <Text style={styles.punktai}>
      ...
      <Text style={styles.punktas}>
        3.6.1. Jeigu be vykdytojo žinios bandyta sumontuoti, permontuoti esančią
        įrangą, sistemą ar jos lydinčias dalis, jeigu užsakovas ir kiti asmenys
        bandė pajungti/pakeisti papildomą/esančią įrangą į vykdytojo sumontuotą
        ir sukonfiguruotą vaizdo stebėjimo sistemą, pvz be vykdytojo žinios ir
        sutarimo pajungtos papildomos kameros, įrašymo įrenginys, atminties
        laikmenos, interneto routeris, tinklo šakotuvas ar bet kokia kita įranga
        kuri dirba tame pačiame internetiniame tinkle, IP adresuose kaip ir
        vaizdo stebėjimo įranga, jos dalys, siųstuvai ir t.t.
      </Text>
      <Text style={styles.punktas}>
      ...
      <Text style={styles.punktai}>
        ...
        įrodo, kad jis buvo sąlygotas kliūties,  kurios ji negalėjo kontroliuoti
        ir kad sutarties sudarymo momentu nebuvo galima protingai tikėtis iš jos
        kliūties numatymo arba tos kliūties ar jos pasekmių išvengimo ar
        įveikimo.
      </Text>
      <Text style={styles.punktai}>
      ...
      <Text style={styles.punktai}>
        4.4 Nepranešimas arba nesavalaikis pranešimas atima šalies teisę remtis
        bet kuria iš aukščiau nurodytų aplinkybių kaip pagrindu, atleidžiančių
        nuo atsakomybės už įsipareigojimų nevykdymą.
      </Text>
      <Text style={styles.punktai}>
        4.5 Tuo atveju, jei šios sutarties 4.1. punkte nurodytos aplinkybės
        nustoja veikti, atitinkama šalis praneša apie tai kitai šaliai raštu per
        7 (septynias) kalendorines dienas.
      </Text>
      <Text style={styles.punktai}>
      ...
      <Text style={styles.punktai}>
        ...
        turi teisę reikalauti perduoti jam atliktų darbų rezultatą, o vykdytojas
        tokiu atveju turi teisę reikalauti apmokėti už faktiškai atliktus
        darbus.
      </Text>
      <Text style={styles.punktai}>
      ...
      <Text style={styles.punktai}>
        5.6 Šioje sutartyje nenumatyti klausimai, tarp jų ir ginčai sprendžiami
        tarpusavio susitarimu. Nepasiekus susitarimo - Lietuvos Respublikos
      ...
      <Text style={styles.susitarimai}>
        Kiti susitarimai: {props.susitarimai}
      </Text>
      <Text
